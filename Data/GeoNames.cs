		...
		internal static async Task Load(System.Threading.CancellationToken cancellationToken = default)
		{
			...
			await Task.Run(() =>
			{
				...
				foreach (var line in File.ReadLines(filePath))
				{
					...
					string countryCode = parts[8]; // countryCode code - ISO-3166 2-letter countryCode code, 2 characters
					...
					allGeoNamesLocations.Add(new GeoNamesLocation(id, name, nameASCII, alternatenames, countryCode, admin1Code, latitude, longitude, population));
				}
